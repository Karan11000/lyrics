...
useEffect(()=>{
  async function getData(){
    const res = await axios.get(`http://api.musixmatch.com/ws/1.1/track.search?q_track=${submitText}&page_size=10&page=1&s_track_rating=desc&apikey=073358cbad4539413d607560a16aa80b`)
    newState({
...
getData();
    // axios.get(
    //     `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.search?q_track=${submitText}&page_size=10&page=1&s_track_rating=desc&apikey=073358cbad4539413d607560a16aa80b`
    //   )
    //   .then(res => {
